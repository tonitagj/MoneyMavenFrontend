  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        const monthlyRes = await axios.get("http://localhost:8080/dashboard/monthly-expenses", { headers });
        const impulseRes = await axios.get("http://localhost:8080/dashboard/impulse-vs-necessity", { headers });
        const dailyRes = await axios.get(
          `http://localhost:8080/dashboard/daily-expenses?month=${selectedMonth}&year=${selectedYear}`,
          { headers }
        );
